var regFill = "blueviolet";
var highlightFill = "rgb(198, 160, 248)";
...
function Tree() {
  ...
  this.addNode = function(node) {
    ...
    .duration(100)
    .attr("y", d => d.cy + 5)
    .call(textAttr, regFillText, 'Poppins', 'sans-serif', "15px")
...
function createArray(arr, x, y, width, height) {
  ...
  arrayContainer.selectAll("text.rect")
    ...
    .attr("y", d => d.y + 30)
    .text(d => d.value)
    .call(textAttr, regFillText, 'Poppins',"sans-serif", "1em")
